export default function VerifyMark({ size = 280, bgColor }) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 280 280" xmlns="http://www.w3.org/2000/svg">
      ...
      <polygon points="50,70 80,70 140,210 110,210" fill="#e8e8e4"/>
      <polygon points="170,70 200,70 140,210 110,210" fill="#e8e8e4"/>
      ...
      <line x1="16" y1="16" x2="30" y2="16" stroke="#2e2e2e" stroke-width="1"/>
      <line x1="16" y1="16" x2="16" y2="30" stroke="#2e2e2e" stroke-width="1"/>
      <line x1="250" y1="16" x2="264" y2="16" stroke="#2e2e2e" stroke-width="1"/>
      <line x1="264" y1="16" x2="264" y2="30" stroke="#2e2e2e" stroke-width="1"/>
      <line x1="16" y1="264" x2="16" y2="250" stroke="#2e2e2e" stroke-width="1"/>
      <line x1="16" y1="264" x2="30" y2="264" stroke="#2e2e2e" stroke-width="1"/>
      <line x1="264" y1="264" x2="264" y2="250" stroke="#2e2e2e" stroke-width="1"/>
      <line x1="250" y1="264" x2="264" y2="264" stroke="#2e2e2e" stroke-width="1"/>
    </svg>
  );
}
